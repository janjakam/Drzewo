...
Contract - https://etherscan.io/apis#contracts

[x] Get Contract ABI for Verified Contract Source Codes => get_contract_abi
[x] Get Contract function call result
...
=end	
	...
	def get_contract_value(address, function_name, data="")
        ...
        payload = "0x" + Digest::SHA3.hexdigest(function_name, 256)[0..7] + data
